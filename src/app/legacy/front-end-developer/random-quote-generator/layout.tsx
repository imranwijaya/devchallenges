...
import { raleway } from "@/utils/legacy/font";
...
const Page: NextPage<Props> = ({ children }) => {
  const content = routesObject.frontEndDeveloper.child.randomQuoteGenerator;

  return (
    <div
      className={`${raleway.className} relative mx-auto flex min-h-screen flex-col text-black 2xl:container 2xl:mx-auto`}
    >
      {children}
