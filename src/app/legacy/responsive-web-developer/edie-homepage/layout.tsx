...
import { poppins, heebo } from "@/utils/legacy/font";
...
export const menus: Menu[] = [
  ...
  {
    name: "Services",
    href: `${content.href}/#services`,
    exact: true,
    child: [],
  },
  {
    name: "Our Works",
    href: `${content.href}/#our-works`,
    exact: true,
    child: [],
  },
  {
    name: "Clients",
    href: `${content.href}/#clients`,
    exact: true,
    child: [],
  },
  {
          ...
          <div className="flex flex-col gap-y-16 px-10 py-9 md:px-16 lg:flex-row lg:justify-between lg:px-36 lg:py-12">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-x-2">
                <NextLink href={content.href} title="Instagram">
                  <InstagramIcon className="h-6 w-6" />
                </NextLink>
                <NextLink href={content.href} title="Linkedin">
                  <LinkedinIcon className="h-6 w-6" />
                </NextLink>
                <NextLink href={content.href} title="Twitter">
