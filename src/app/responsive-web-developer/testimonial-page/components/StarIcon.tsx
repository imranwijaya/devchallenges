...
const StarIcon: NextPage<Props> = ({
  useGradient = false,
  gradientStartColor = "rgb(251,198,36)",
  gradientViaColor = "rgb(255,255,218)",
  ...
  <svg
    ...
    height="24"
    viewBox="0 0 24 24"
    fill={useGradient ? "url(#gradient-vertical)" : "rgb(245,192,68)"}
    stroke={useGradient ? "rgb(210,147,26)" : "rgb(245,192,68)"}
    strokeWidth={useGradient ? "0.3" : "2"}
    ...
    {useGradient && (
      <defs>
        ...
        >
          <stop
            offset="0%"
            style={{ stopColor: gradientStartColor, stopOpacity: 0.7 }}
          />
          <stop
            offset="50%"
            style={{ stopColor: gradientViaColor, stopOpacity: 1 }}
          />
          <stop
            offset="100%"
            style={{ stopColor: gradientStopColor, stopOpacity: 1 }}
          />
        </linearGradient>
      </defs>
    )}
