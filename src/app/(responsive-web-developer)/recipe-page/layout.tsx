...
import { monsterrat, playfairDisplay } from "@/utils/font";
...
const Page: NextPage<Props> = ({ children }) => {
  return (
    <div
      className={`${monsterrat.className} ${playfairDisplay.variable} flex min-h-screen flex-col 2xl:container 2xl:mx-auto`}
    >
      ...
      <BottomNavigation
        pageRoute="/recipe-page"
        readmeRoute="/recipe-page/readme"
        pageComponent={
          <NextLink
            href="/recipe-page/readme"
        ...
        readmeComponent={
          <NextLink href="/recipe-page" className="group/readme text-white">
            <div className="flex w-full gap-x-2 rounded-full bg-slate-700 p-2">
